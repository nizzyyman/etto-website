  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-[1400px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-[300px_1fr_400px] grid-rows-[auto_auto] gap-x-10 gap-y-10 p-10 text-[#333]">
          
          {/* Column 1, Row 1: Profile Header & Bio */}
          ...
          {/* Column 1, Row 2: Profile Photo & Button */}
          <div className="flex flex-col gap-5">
          ...
          {/* Column 3, Row 2: Inspiration Photos */}
